            ...
            >
                <div className="relative">
                    {eq.imageUrl ? (
                        ...
                        <div className="w-full h-32 sm:h-40 lg:h-48 bg-gradient-to-br from-orange-100 to-orange-200 flex items-center justify-center">
                    ...
                    <div className="p-3 sm:p-4">
                        ...
                        <div className="flex justify-between items-center">
                            <span className="text-[#071d40] font-bold text-base sm:text-lg">${eq.price.toLocaleString()}</span>
                            {selectedEquipment.includes(eq.id) && (
                                <span className="text-xs sm:text-sm font-medium text-[#071d40]">Seleccionado</span>
                            )}
                        </div>
                    </div>
                </div>

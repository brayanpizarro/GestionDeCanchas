...
const ReservationSummaryComponent: React.FC<ReservationSummaryProps> = ({ summary, isLoading, onConfirm }) => {
    ...
    return (
        ...
        <h3 className="text-xl font-semibold text-[#071d40] mb-6 flex items-center">
        ...
        <div className="space-y-4 mb-6">
            ...
            <div className="flex items-start space-x-3">
                ...
                <p className="text-sm text-gray-600">${court.price.toLocaleString()}/hora</p>
                </div>
            </div>
            )}
            ...
            <div className="flex items-start space-x-3">
                ...
                <ul className="space-y-1">
                    {equipment.map((eq) => (
                    <li key={eq.id} className="text-sm font-medium text-gray-900">
        ...
        <div className="border-t pt-4 mb-6">
            ...
            <span className="text-2xl font-bold text-[#071d40]">${total.toLocaleString()}</span>
            </div>
        </div>
